...
```
    ...
    --2020-06-23 13:29:45--  http://ai.stanford.edu/~amaas/data/sentiment/aclImdb_v1.tar.gz
...
**Answer:**
1. The method does the basic pre-processing required for natural language processing.
2. We apply Stemming to the input data to get a generalized form of each word.
3. All the words are lowercased to avoid duplicates with same meaning.
4. Symbols and irrelevant text is discarded to reduce the noise.
5. Stopwards which could appear very frequently and make no sense are removed.
...
**Answer:**
1. 'movi', 'film', 'one', 'like', 'time'are the five most frequent words and it makes sense since it relates to reviews data.
...
**Answer:**
1. Since the machine learning algorithms/model cannot make sense from the text we do the necessary preprocessing steps in order to make the text compliant to the algorithms/model.
2. When the model receives input, for it make sense out of the input it needs to undergo the same preprocessing as in the test data otherwise the model's predictions will be poor.
3. The only problem that can occur is that the test data coming from a different distribution which will result in poor predictions.
4. This can be dealt by updating the model vocabulary.
...
```
    ...
    2020-06-23 14:46:08 Training - Training image download completed. Training in progress.[34mbash: cannot set terminal process group (-1): Inappropriate ioctl for device[0m
    [34mbash: no job control in this shell[0m
    [34m2020-06-23 14:46:09,614 sagemaker-containers INFO     Imported framework sagemaker_pytorch_container.training[0m
    [34m2020-06-23 14:46:09,638 sagemaker_pytorch_container.training INFO     Block until all host DNS lookups succeed.[0m
    [34m2020-06-23 14:46:10,252 sagemaker_pytorch_container.training INFO     Invoking user training script.[0m
    [34m2020-06-23 14:46:10,534 sagemaker-containers INFO     Module train does not provide a setup.py. [0m
    [34mGenerating setup.py[0m
    [34m2020-06-23 14:46:10,534 sagemaker-containers INFO     Generating setup.cfg[0m
    [34m2020-06-23 14:46:10,534 sagemaker-containers INFO     Generating MANIFEST.in[0m
    [34m2020-06-23 14:46:10,534 sagemaker-containers INFO     Installing module with the following command:[0m
    ...
    [34m  Running setup.py bdist_wheel for nltk: finished with status 'done'
      ...
      Stored in directory: /tmp/pip-ephem-wheel-cache-9m1iclsp/wheels/35/24/16/37574d11bf9bde50616c67372a334f94fa8356bc7164af8ca3
    ...
    [34m2020-06-23 14:46:33,463 sagemaker-containers INFO     Invoking user script
    [0m
    [34mTraining Env:
    [0m
    [34m{
        ...
        "module_dir": "s3://sagemaker-us-east-2-152592716204/sagemaker-pytorch-2020-06-23-14-42-13-201/source/sourcedir.tar.gz",
        ...
        "job_name": "sagemaker-pytorch-2020-06-23-14-42-13-201",
        "input_data_config": {
            "training": {
    ...
    [34mSM_MODULE_DIR=s3://sagemaker-us-east-2-152592716204/sagemaker-pytorch-2020-06-23-14-42-13-201/source/sourcedir.tar.gz[0m
    ...
    [34mEpoch: 1, BCELoss: 0.6726251220216557[0m
    [34mEpoch: 2, BCELoss: 0.5979122312701478[0m
    [34mEpoch: 3, BCELoss: 0.5270530496324811[0m
    [34mEpoch: 4, BCELoss: 0.4490671170001127[0m
    [34mEpoch: 5, BCELoss: 0.4128714714731489[0m
    [34mEpoch: 6, BCELoss: 0.40253147908619474[0m
    [34mEpoch: 7, BCELoss: 0.3597642718529215[0m
    [34mEpoch: 8, BCELoss: 0.33334174630593283[0m
    [34mEpoch: 9, BCELoss: 0.3121759356284628[0m
    
    2020-06-23 14:49:42 Uploading - Uploading generated training model
    2020-06-23 14:49:42 Completed - Training job completed
    [34mEpoch: 10, BCELoss: 0.2970385502795784[0m
    [34m2020-06-23 14:49:35,346 sagemaker-containers INFO     Reporting training SUCCESS[0m
...
**Answer:**
1. The XGBoost model perfomed slightly better than LSTM Network here.
2. The first reason is that we are using a simple LSTM maybe stacking LSTM cells might give better results whereas XGBoost is initialized with a good set a parameters.
3. There is not a single best model for sentiment analysis since it depends on data and data preprocessing.
...
**Answer:**
1. Review : "Movie of the year! Deserves all the praise."
2. Predicted sentiment: "Your review was POSITIVE!"
